...
(function() {
  var config, configContent, configFile, configFromArgs, encrypt, fs, inetAton, inetNtoa, k, key, net, path, port, portPassword, timeout, util, v, _fn;
  ...
  _fn = function() {
    var KEY, PORT, decryptTable, encryptTable, server, tables;
    PORT = port;
    KEY = key;
