...
(function() {
  var Encryptor, KEY, METHOD, PORT, REMOTE_PORT, SERVER, args, config, configContent, configFromArgs, fs, getServer, inet, inetAton, inetNtoa, k, net, path, server, timeout, util, v;
