...
(function() {
  var Encryptor, KEY, METHOD, PORT, REMOTE_PORT, SERVER, args, config, configContent, configFromArgs, createServer, fs, inet, inetAton, inetNtoa, k, net, path, timeout, util, v;
