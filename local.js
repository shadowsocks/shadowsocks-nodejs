...
(function() {
  var Encryptor, KEY, PORT, REMOTE_PORT, SERVER, config, configContent, configFromArgs, encryptor, fs, getServer, inetAton, inetNtoa, k, net, path, server, timeout, util, v;
