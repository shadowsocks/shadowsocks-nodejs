...
(function() {
  var Encryptor, KEY, METHOD, PORT, REMOTE_PORT, SERVER, config, configContent, configFromArgs, connections, createServer, fs, inet, inetAton, inetNtoa, k, net, path, s, timeout, utils, v;
