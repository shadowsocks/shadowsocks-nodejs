...
(function() {
  var Encryptor, connections, createServer, fs, inet, inetAton, inetNtoa, net, path, utils;
  ...
  exports.main = function() {
    var KEY, METHOD, PORT, REMOTE_PORT, SERVER, config, configContent, configFromArgs, configPath, k, s, timeout, v;
    ...
    timeout = Math.floor(config.timeout * 1000) || 600;
