...
(function() {
  ...
  exports.main = function() {
    var METHOD, SERVER, config, configContent, configFromArgs, configPath, connections, inetAton, inetNtoa, k, key, port, portPassword, timeout, v, _results;
            ...
            if (stage === 0) {
              try {
                ...
                if (addrtype === 1) {
                  ...
                  while(idx < 17)
                  {
                    remoteAddr += data.slice(idx, idx+2).toString("hex") + ':';
                    idx += 2;
                  }
                  remoteAddr = remoteAddr.substr(0, remoteAddr.length - 1);
