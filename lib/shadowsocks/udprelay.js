...
(function() {
  var LRUCache, decrypt, dgram, encrypt, encryptor, inet, inetAton, inetNtoa, net, utils;
  ...
  exports.createServer = function(listenAddr, listenPort, remoteAddr, remotePort, password, method, timeout, isLocal) {
    ...
    for (_i = 0, _len = udpTypesToListen.length; _i < _len; _i++) {
      ...
      server.on("message", function(data, rinfo) {
        var addrLen, addrtype, client, clientUdpType, dataToSend, destAddr, destPort, frag, headerLength, key, requestHeaderOffset, sendDataOffset, serverAddr, serverPort, _ref, _ref1;
        headerLength = 0;
