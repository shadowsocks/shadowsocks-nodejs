...
(function() {
  var EVP_BytesToKey, Encryptor, cachedTables, crypto, encrypt, getTable, int32Max, merge_sort, method_supported, util;
    ...
    Encryptor.prototype.decrypt = function(buf) {
      ...
      if (this.method != null) {
        if (this.decipher == null) {
          ...
          result = new Buffer(this.decipher.update(buf.slice(decipher_iv_len).toString('binary')), 'binary');
          return result;
        } else {
